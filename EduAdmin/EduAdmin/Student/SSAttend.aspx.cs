...
public partial class Student_Default2 : System.Web.UI.Page
{
    ...
    protected void Button14_Click(object sender, EventArgs e)
    {
        ...
        //  string EduAdminConnectionString2 = ConfigurationManager.ConnectionStrings["EduAdminConnectionString2"].ConnectionString;
        //   SqlConnection con = new SqlConnection(EduAdminConnectionString2);
        ...
        SqlConnection con1 = new SqlConnection(EduAdminConnectionString2);
        con1.Open();
      ...
      //  String count = "SELECT COUNT(class) FROM " + course + "AttMst WHERE studentname='"+ name + "' and class='" + DropDownList2.SelectedItem.Text + "'";
        ...
        SqlConnection con2 = new SqlConnection(EduAdminConnectionString2);
        con2.Open();
