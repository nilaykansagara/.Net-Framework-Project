                            ...
                            <asp:MultiView ID="MultiView1" runat="server">
                                ...
                                <asp:View ID="View4" runat="server">
                                    <table class="tbl">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EduAdminConnectionString2 %>" SelectCommand="SELECT DISTINCT [Name], [Email] FROM [StaffMst]"></asp:SqlDataSource>
                                            </td>
                                        </tr>
                                    </table>
                                </asp:View>
