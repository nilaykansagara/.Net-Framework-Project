...
&nbsp;<asp:Button ID="btnsearch" runat="server" CssClass="btn" onclick="btnsearch_Click" 
        ...
        <tr>
            <td>
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EduAdminConnectionString2 %>" SelectCommand="SELECT DISTINCT [Staff] FROM [UploadMst]"></asp:SqlDataSource>
            </td>
        </tr>
    </table>
</asp:Content>
