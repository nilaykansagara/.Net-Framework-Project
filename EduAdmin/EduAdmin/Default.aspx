...
<body>
    ...
    <div id="top">
        ...
        <asp:Image ID="Image1"  Height="116px" runat="server" ImageUrl="~/EduAdmin.png" />
        ...
        <asp:Menu ID="Menu1" runat="server" Orientation="Horizontal" Width="100%" 
            ...
            <Items>
                ...
                <asp:MenuItem Text="ADMIN" Value="LOGIN" 
	...
	<div class="ws_images">
<a href="#"><img src="data1/images/demo4.png" alt="" title="" id="wows0"/></a>
<a href="#"><img src="data1/images/demo1.png" alt="" title="" id="wows1"/></a>
...
<a href="#"><img src="data1/images/8.jpg" alt="" title="" id="wows4"/></a>
    ...
    <div id="logoo">
        <table width="100%">
            <tr>
                <td class="log">
                   <marquee BEHAVIOR=ALTERNATE><span class="log">Education Administration Software</span></marquee></td>
            </tr>
        </table>
    </div>
    <div id="footer" 
