...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:EduAdminConnectionString2 %>" SelectCommand="SELECT DISTINCT [class] FROM [CourseMst]">
        </asp:SqlDataSource>
  
       
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EduAdminConnectionString2 %>" SelectCommand="SELECT DISTINCT [Course] FROM [StudentMst]"></asp:SqlDataSource>
